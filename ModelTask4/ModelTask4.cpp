...
// ModelTask4.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CModelTask4App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CModelTask4App

CModelTask4App::CModelTask4App()
{
...
// Единственный объект CModelTask4App

CModelTask4App theApp;


// Инициализация CModelTask4App

BOOL CModelTask4App::InitInstance()
{
